...
class Paintable(object):
    ...
    def setBounds(self, minimum = None, maximum = None):
        if minimum is not None: self.getHistogram().SetMinimum(minimum)
        if maximum is not None: self.getHistogram().SetMaximum(maximum)
...
class StackPaintable(Paintable):
    ...
    def setBounds(self, minimum = None, maximum = None):
        if minimum is not None: self.stack.SetMinimum(minimum)
        if maximum is not None: self.stack.SetMaximum(maximum)
