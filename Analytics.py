...
def run_analysis(_st_jetcb,_minnjet_val,_maxnjet_val,_st_btagjetcb,_btagmin_val, _btagmax_val, _st_lepcb, _nlep_val,_st_lepptcb, _leppt_val, _LepTmass_val, _LepTmassMax_val, _st_lepchargecb, _TwoLepcharge_val, _st_lepflavourcb, _TwoLepflavour_val, _st_InvMasscb, _InvariantM_val, _Range_val, _InvariantM2_val, _minmissE_val, _maxmissE_val, _st_missPcb, _percentg_val):
    """runs the analysis"""
